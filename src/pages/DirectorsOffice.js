      ...
      <div className="directors-office">
        ...
        <section className="directors-hero">
          <div className="container">
            ...
            <FadeInUp delay={0.6}>
              <div className="directors-hero-actions">
                <Link to="/contact" className="btn btn-primary directors-hero-btn">
                  Contact Us
                </Link>
                <Link to="/our-story" className="btn btn-secondary directors-hero-btn">
                  Our Story
                </Link>
              </div>
            </FadeInUp>
        ...
        {/* Contact Directors */}
        <section className="contact-directors section">
          <div className="container">
            <FadeInUp>
